    ...
    >
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-14 px-6 lg:grid-cols-2">
        <Reveal>
          ...
          <div className="frame-gold relative mt-9 hidden aspect-[3/2] overflow-hidden rounded-sm shadow-2xl shadow-black/40 lg:block">
            <Image
        ...
        <div className="space-y-5">
          ...
          <Reveal delay={0.24}>
            <p className="pt-2 text-center font-serif text-sm italic text-ivory/55">
